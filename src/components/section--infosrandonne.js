...
class SectionRandonne extends React.Component {
  // constructor(props) {
  //   super(props);
...
const sectionContainer = document.querySelector('#section--infosrandonne');
ReactDOM.render(e(SectionRandonne), sectionContainer);