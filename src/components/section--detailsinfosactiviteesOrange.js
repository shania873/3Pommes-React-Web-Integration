...
class detailsinfosactiviteesOrange extends React.Component {
    render() {
               ...
               <div className="row--detailsinfosactivitees">
                ...
                <div className="container setTitle--detailsinfosactivitees">
                            <div className="col-lg-6 col-md-6 col-sm-8 col-xs-12">
                                <span className="orange--Typo">Activité open</span>
                                    <h3>Multi activitées sport nature 8/11</h3>
                                </div>
                                <div className="col-lg-1 col-sm-1 xs-hidden">
                                    <img src="../src/img/icon-tubas.svg"/>
                                </div>
                            </div>  
               
                        <div className="setContent--detailsinfosactivitees orange--Bg">
                            <div className="container">
                                <div className="col-sm-7 col-xs-12 leftCol--detailsinfosactivitees">
                                ...
                                <div className="col-sm-4 col-xs-12 rightCol--detailsinfosactivitees ">
...
const sectionContainer = document.querySelector('#section--detailsinfosactiviteesOrange');
ReactDOM.render(e(detailsinfosactiviteesOrange), sectionContainer);